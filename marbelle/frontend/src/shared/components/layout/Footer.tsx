...
function Footer() {
    ...
    return (
        <footer className="bg-white text-gray-900 border-t border-gray-900">
            <div className="container mx-auto px-4 py-12">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    <div>
                        <h3 className="text-xl font-bold mb-4">Marbelle</h3>
                        <p className="text-gray-900">{t('footer.description')}</p>
                    </div>
                    <div>
                    ...
                    >
                        <div className="flex items-center space-x-2">
                            ...
                            <DrawerTrigger asChild>
                                <button className="flex items-center space-x-1 hover:text-gray-600 transition-colors cursor-pointer">
