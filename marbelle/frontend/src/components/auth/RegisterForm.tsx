...
const validation = {
    ...
    first_name: [
        { validator: validationRules.required, message: 'FIRST NAME IS REQUIRED' },
    ],
    last_name: [
        { validator: validationRules.required, message: 'LAST NAME IS REQUIRED' },
    ],
    password: [
    ...
    phone: [
        { validator: validationRules.phone, message: 'VALID PHONE NUMBER IS REQUIRED' },
    ],
};
...
export const RegisterForm: React.FC = () => {
    ...
    const passwordMatchError = values.password !== values.password_confirm && touched.password_confirm
        ...
        <form onSubmit={handleSubmit} className="max-w-md mx-auto p-8 bg-white rounded-lg shadow-md space-y-6">
            ...
            <div>
                ...
                <p className="text-xs text-gray-500 mt-1 uppercase">
                    FOR BUSINESS CUSTOMERS WITH SPECIAL PRICING
                </p>
            </div>
            ...
            <div>
                ...
                {errors.phone && touched.phone && (
                    <p className="text-red-500 text-xs mt-1 uppercase">{errors.phone}</p>
                )}
            </div>
